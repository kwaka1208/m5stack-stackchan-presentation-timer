...
![framework](https://img.shields.io/badge/framework-ESP--IDF%20v5.5-blue)
...
[ESP-IDF v5.5](https://docs.espressif.com/projects/esp-idf/) が必要です。
...
首振りやサーボの中心位置は `main/main.cpp` の定数で調整できます。
...
- FEETECH FTServo ドライバ(`components/scservo/`) — MIT (© ftservo)。
  [M5Stack/StackChan-BSP](https://github.com/m5stack/StackChan-BSP) 経由で取り込み。詳細は
  [`components/scservo/README.md`](components/scservo/README.md) を参照。
